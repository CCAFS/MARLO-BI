...
CREATE TABLE `fact_deliverables` (
   ...
   KEY `fact_deliverables_ibfk_17` (`fk_id_crp`),
   ...
   CONSTRAINT `fact_deliverables_ibfk_17` FOREIGN KEY (`fk_id_crp`) REFERENCES `dim_crps` (`pk_id_crp`) ON DELETE RESTRICT ON UPDATE RESTRICT

...
CREATE TABLE `fact_fs` (
  ...
  primary key (`fk_id_year`, `fk_id_fs_info`, `fk_id_crp`, `fk_id_intersect_group_loc`, `fk_id_intersect_group_inst`,
  `fk_id_inst_orig_donor`,`fk_id_inst_direct_donor`,`fk_id_inst_lead_center`, `fk_id_agreement_status`),
  KEY `idx_fact_fs_tk` (`fk_id_year`, `fk_id_fs_info`, `fk_id_crp`, `fk_id_intersect_group_loc`, `fk_id_intersect_group_inst`,
  `fk_id_inst_orig_donor`,`fk_id_inst_direct_donor`,`fk_id_inst_lead_center`, `fk_id_agreement_status`)

...
CREATE TABLE `fact_fs` (
  ...
  CONSTRAINT `fact_fs_ibfk_7` FOREIGN KEY (`fk_id_agreement_status`) REFERENCES `dim_fs_agreement_statuses` (`pk_id_fs_agreement_status`) ON DELETE RESTRICT ON UPDATE RESTRICT
